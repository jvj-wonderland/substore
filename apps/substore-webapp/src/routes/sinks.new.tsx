...
import { RiArrowLeftLine, RiPlayLine, RiSaveLine, RiTerminalLine, RiCodeLine, RiFileTextLine, RiErrorWarningLine } from "@remixicon/react"
    ...
    <div className="flex flex-col h-full bg-background">
      <div className="border-b bg-background/95 backdrop-blur px-8 py-4 flex items-center justify-between sticky top-0 z-10">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="text-xl font-bold tracking-tight">New Sink</h2>
            <p className="text-[10px] text-muted-foreground uppercase tracking-widest font-semibold">Creation Mode</p>
          </div>
        </div>
        <div className="flex gap-2">
          ...
          <Button onClick={(e) => handleSave(e as any)} disabled={addMutation.isPending}>
